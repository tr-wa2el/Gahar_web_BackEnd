...
{
    /// <inheritdoc />
    public partial class AddFacilitiesManagementTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBeds = table.Column<int>(type: "int", nullable: true),
                    AverageWaitTime = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Facilities_Users_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityDepartments_FacilityId_DisplayOrder",
                table: "FacilityDepartments",
                columns: new[] { "FacilityId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_FacilityImages_FacilityId_DisplayOrder",
                table: "FacilityImages",
                columns: new[] { "FacilityId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_FacilityReviews_FacilityId_IsApproved_CreatedAt",
                table: "FacilityReviews",
                columns: new[] { "FacilityId", "IsApproved", "CreatedAt" },
                descending: new[] { false, false, true });

            migrationBuilder.CreateIndex(
                name: "IX_FacilityServices_FacilityId_DisplayOrder",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "CreatedAt",
                value: new DateTime(2025, 11, 13, 7, 37, 50, 979, DateTimeKind.Utc).AddTicks(3886));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                column: "CreatedAt",
                value: new DateTime(2025, 11, 13, 7, 37, 50, 979, DateTimeKind.Utc).AddTicks(3888));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "CreatedAt",
                value: new DateTime(2025, 11, 13, 7, 37, 50, 979, DateTimeKind.Utc).AddTicks(3975));
        }
    }
}
