...
{
    /// <inheritdoc />
    public partial class AddContentTypesFeature : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSinglePage = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    Direction = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true, defaultValue: "ltr"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTranslatable = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentTypeFieldId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Id", "Code", "CreatedAt", "DeletedAt", "Direction", "IsActive", "IsDefault", "IsDeleted", "Name", "UpdatedAt" },
                values: new object[] { 1, "ar", new DateTime(2025, 11, 12, 19, 7, 15, 933, DateTimeKind.Utc).AddTicks(8588), null, "ltr", true, true, false, "العربية", null });

            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Id", "Code", "CreatedAt", "DeletedAt", "Direction", "IsActive", "IsDeleted", "Name", "UpdatedAt" },
                values: new object[] { 2, "en", new DateTime(2025, 11, 12, 19, 7, 15, 933, DateTimeKind.Utc).AddTicks(8590), null, "ltr", true, false, "English", null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "Description", "DisplayName", "IsDeleted", "Name", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2025, 11, 12, 19, 7, 15, 933, DateTimeKind.Utc).AddTicks(8676), null, null, "مدير النظام", false, "SuperAdmin", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translations_EntityType_EntityId_FieldName_LanguageId",
                table: "Translations",
